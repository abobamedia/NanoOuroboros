...
[![Version 4.18.14](https://img.shields.io/badge/version-4.18.14-green.svg)](VERSION)
...
| 4.18.12 | 2026-04-27 | Synchronize worker SHA verification with the live repo HEAD before comparing booted workers, eliminating false mismatch warnings after legitimate restarts while preserving real mismatch detection. |
...
| 4.18.4 | 2026-04-15 | Cloud.ru direct-provider defaults now prefill `cloudru::zai-org/GLM-4.7` instead of `cloudru::GigaChat/GigaChat-2-Max` across onboarding suggestions, defaults, and regression coverage. |
